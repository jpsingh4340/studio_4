...
const RentalFeedbackForm = ({
  ...
  const validateForm = () => {
    ...
    if (formData.wouldRecommend === null) {
      newErrors.wouldRecommend =
        "Please let us know if you would recommend this equipment";
    }
          ...
          <div className="equipment-info">
            ...
            {equipmentData.rentalDate && (
              <p className="rental-date">
                Rented on:{" "}
                {new Date(equipmentData.rentalDate).toLocaleDateString()}
              </p>
            )}
          </div>
        ...
        <form onSubmit={handleSubmit} className="feedback-form">
          ...
          <div className="form-group">
            ...
            {errors.equipmentCondition && (
              <span className="error-message">{errors.equipmentCondition}</span>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            {errors.serviceRating && (
              <span className="error-message">{errors.serviceRating}</span>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            {errors.wouldRecommend && (
              <span className="error-message">{errors.wouldRecommend}</span>
            )}
          </div>
