        ...
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <section className="mb-4">
              ...
              <p className="small">
                By accessing and using RentMate ("the Platform"), you accept and
            ...
            <section className="mb-4">
              ...
              <p className="small">
                RentMate is an online marketplace that connects equipment owners
                with individuals and businesses seeking to rent equipment. We
                facilitate transactions but do not own the equipment listed on
                our platform.
              </p>
            </section>
            ...
            <section className="mb-4">
              ...
              <p className="small">
                <strong>Equipment Owners:</strong>
              </p>
              <ul className="small">
                <li>
                  Must provide accurate descriptions and conditions of equipment
                </li>
            ...
            <section className="mb-4">
              ...
              <p className="small">
                RentMate charges a service fee for each successful rental
                transaction. Payment processing is handled through secure
                third-party providers. All fees are clearly disclosed before
            ...
            <section className="mb-4">
              ...
              <p className="small">
                Users are responsible for their own insurance coverage. RentMate
                does not provide insurance for equipment or assume liability for
                damages, injuries, or losses that may occur during rental
                periods.
              </p>
            </section>
            ...
            <section className="mb-4">
              ...
              <p className="small">
                While RentMate provides a platform for communication and may
                assist in dispute resolution, users are primarily responsible
                for resolving conflicts between themselves. Serious disputes may
                be subject to mediation or arbitration.
              </p>
            </section>
            ...
            <section className="mb-4">
              ...
              <p className="small">
                RentMate reserves the right to suspend or terminate accounts
                that violate these terms, engage in fraudulent activity, or pose
            ...
            <section className="mb-4">
              ...
              <p className="small">
                ...
                of significant changes and continued use of the platform
          ...
          <div className="modal-body">
            ...
            <section className="mb-4">
              ...
              <p className="small">
                ...
                services and comply with legal obligations. Account data is
                typically deleted within 30 days of account closure, except
            ...
            <section className="mb-4">
              ...
              <p className="small">
                RentMate is not intended for users under 18 years of age. We do
            ...
            <section className="mb-4">
              ...
              <p className="small">
                ...
                you of significant changes by email or through the platform.
