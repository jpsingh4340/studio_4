// Temporary QR Scanner fallback for CI/CD fix
const QrReader = ({ onResult, onError, ...props }) => {
  return (
    <div style={{ 
      padding: '20px', 
      ...
      <p>📱 QR Scanner</p>
      <p>QR scanning temporarily disabled</p>
      <button 
        onClick={() => onResult && onResult('demo-qr-code')}
  ...
  return (
    <div className="card">
      <div className="card-body text-center">
        <i className="bi bi-qr-code-scan display-4 text-primary mb-3" />
      ...
      <div className="card-body">
        <div className="row g-2">
          <div className="col-6">
            ...
            >
              <i className="bi bi-person-badge d-block mb-1" />
        ...
        <div className="row g-2">
          <div className="col-6">
            <button
              ...
              className="btn btn-outline-primary btn-sm w-100"
            >
              <i className="bi bi-person-plus d-block mb-1" />
  ...
  return (
    <>
      ...
      >
        ...
        >
          <i className={`bi ${showMenu ? "bi-x" : "bi-qr-code"} fs-5`} />
        </button>
      </div>
