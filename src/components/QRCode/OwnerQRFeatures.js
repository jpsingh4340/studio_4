      ...
      <div className="row mb-4">
        <div className="col">
          ...
          <p className="text-muted">
            Generate QR codes for your equipment to enable quick rentals and
            tracking.
          </p>
        </div>
      </div>
          ...
          <div className="row align-items-center">
            <div className="col-md-8">
              ...
              <p className="text-muted mb-0">
                Generate QR code to verify your identity during equipment
                handovers
              </p>
            </div>
            <div className="col-md-4 text-md-end">
              <button onClick={generateOwnerAuthQR} className="btn btn-primary">
                <i className="bi bi-qr-code me-2" />
                Generate Auth QR
              </button>
            </div>
        ...
        <div className="card-body">
          {mockEquipment.length > 0 ? (
            ...
            <div className="text-center py-4">
              ...
              <p className="text-muted">
                Add some equipment to generate QR codes
              </p>
            </div>
          )}
        </div>
