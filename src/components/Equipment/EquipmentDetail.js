      ...
      <div className="row">
        ...
        <div className="col-lg-6 mb-4">
          <div className="equipment-image-container">
            {equipment.imageUrl ? (
              ...
              >
                <div className="text-center text-muted">
                  <i className="bi bi-image" style={{ fontSize: "4rem" }} />
            ...
            {/* Image fallback */}
            <div
              className="d-none align-items-center justify-content-center bg-light rounded shadow"
              style={{ width: "100%", height: "400px" }}
            >
              <div className="text-center text-muted">
                <i className="bi bi-image" style={{ fontSize: "4rem" }} />
          ...
          <div className="equipment-details">
            ...
            <div className="mb-4">
              ...
              <div className="d-flex flex-wrap align-items-center gap-2 mb-3">
                ...
                <span
                  className={`badge fs-6 ${equipment.available ? "bg-success" : "bg-danger"}`}
                >
                  {equipment.available ? "Available" : "Currently Rented"}
                </span>
                {equipment.approvalStatus && (
                  <span
                    className={`badge fs-6 ${equipment.approvalStatus === "approved" ? "bg-success" : "bg-warning"}`}
                  >
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <div>
                      ...
                      <span className="fw-medium">
                        {equipment.ownerName || "Equipment Owner"}
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <div className="rental-actions">
              {equipment.available &&
              (equipment.ownerId === currentUser?.uid ||
                equipment.approvalStatus === "approved" ||
                !equipment.approvalStatus ||
                ...
                <div className="alert alert-warning">
                  ...
                  {!equipment.available
                    ...
                    : equipment.approvalStatus === "pending" &&
                        equipment.ownerId !== currentUser?.uid
                      ? "This equipment is pending approval and cannot be rented yet."
                      : "This equipment is not available for rental at this time."}
                </div>
              )}
            ...
            <div className="mt-4 p-3 bg-light rounded">
              ...
              <ul className="list-unstyled mb-0 small">
                <li>
                  <i className="bi bi-check text-success me-1" /> Secure
                  payment processing
                </li>
                <li>
                  <i className="bi bi-check text-success me-1" /> Equipment
                  condition guarantee
                </li>
                <li>
                  <i className="bi bi-check text-success me-1" /> 24/7
                  customer support
                </li>
                <li>
                  <i className="bi bi-check text-success me-1" /> Flexible
                  rental periods
                </li>
              </ul>
            </div>
