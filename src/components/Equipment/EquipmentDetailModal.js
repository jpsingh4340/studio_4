          ...
          <div className="modal-body p-0">
            ...
            >
              {equipment.imageUrl ? (
                <img
                  ...
                  onError={e => {
                    ...
                    e.target.src =
                      "https://via.placeholder.com/600x250?text=No+Image+Available";
                  }}
                />
              ) : (
                <div className="d-flex align-items-center justify-content-center h-100">
                  <i className="bi bi-tools display-1 text-muted" />
                </div>
              )}
              ...
              <div className="position-absolute top-0 end-0 m-3">
                <span
                  className={`badge ${equipment.available ? "bg-success" : "bg-danger"} me-2`}
                >
            ...
            <div className="p-4">
              ...
              <div className="mb-4">
                <div className="d-flex align-items-center">
                  <span className="h3 text-success fw-bold me-2">
              ...
              <div className="mb-4">
                <h6 className="fw-semibold text-dark mb-2">
                  <i className="bi bi-card-text me-2" />Description
                </h6>
              ...
              <div className="row mb-4">
                <div className="col-md-6">
                  <div className="mb-3">
                    <h6 className="fw-semibold text-dark mb-2">
                      <i className="bi bi-person me-2" />Owner
                    </h6>
                    <p className="text-muted mb-0">
                      {isOwnEquipment
                        ? "You"
                        : equipment.ownerName || "Unknown Owner"}
                    </p>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="mb-3">
                    <h6 className="fw-semibold text-dark mb-2">
                      <i className="bi bi-geo-alt me-2" />Location
                    </h6>
                    <p className="text-muted mb-0">
                ...
                <div className="col-md-6">
                  <div className="mb-3">
                    <h6 className="fw-semibold text-dark mb-2">
                      <i className="bi bi-calendar me-2" />Listed Date
                    </h6>
                    <p className="text-muted mb-0">
                ...
                <div className="col-md-6">
                  <div className="mb-3">
                    <h6 className="fw-semibold text-dark mb-2">
                      <i className="bi bi-check-circle me-2" />Status
                    </h6>
                    <span
                      className={`badge ${equipment.status === "approved" ? "bg-success" : "bg-warning"}`}
                    >
              ...
              {equipment.features && equipment.features.length > 0 && (
                <div className="mb-4">
                  <h6 className="fw-semibold text-dark mb-3">
                    <i className="bi bi-star me-2" />Key Features
                  </h6>
                  <div className="row">
              ...
              {!isOwnEquipment && (
                <div className="alert alert-info">
                  ...
                  <p className="mb-2">
                    Contact the owner to discuss rental terms and availability.
                  </p>
                  <small className="text-muted">
                    Owner: {equipment.ownerName} • Location:{" "}
                    {equipment.location}
                  </small>
                </div>
              )}
