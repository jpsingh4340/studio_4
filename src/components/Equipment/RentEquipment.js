  ...
  useEffect(() => {
    const fetchEquipment = async () => {
      try {
        ...
        // Removed approval status check to allow all equipment to be rented
                  ...
                  <form onSubmit={handleBooking}>
                    ...
                    <div className="mb-4">
                      ...
                      <textarea
                        ...
                        onChange={e =>
                          handleContactInfoChange("notes", e.target.value)
                        }
                        className="form-control"
                        rows="3"
                    ...
                    <div className="mt-3 text-center">
                      <small className="text-muted">
                        ...
                        Your request will be sent to the equipment owner for
                        approval
                      </small>
                    </div>
                  </form>
                    ...
                    <div className="col-md-6">
                      <div className="d-flex align-items-start">
                        <div className="bg-primary bg-opacity-10 rounded-circle p-2 me-3 flex-shrink-0">
                          <i className="bi bi-1-circle text-primary" />
                        </div>
                        <div>
                          <h6 className="mb-1">Request Sent</h6>
                          <small className="text-muted">
                            Your rental request is sent to the equipment owner
                          </small>
                        </div>
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="d-flex align-items-start">
                        <div className="bg-warning bg-opacity-10 rounded-circle p-2 me-3 flex-shrink-0">
                          <i className="bi bi-2-circle text-warning" />
                        </div>
                        <div>
                          <h6 className="mb-1">Owner Review</h6>
                          <small className="text-muted">
                            The owner reviews your request (usually within 24
                            hours)
                          </small>
                        </div>
                      </div>
                    ...
                    <div className="col-md-6">
                      <div className="d-flex align-items-start">
                        <div className="bg-success bg-opacity-10 rounded-circle p-2 me-3 flex-shrink-0">
                          <i className="bi bi-3-circle text-success" />
                        </div>
                        <div>
                          <h6 className="mb-1">Get Notified</h6>
                          <small className="text-muted">
                            You'll receive a notification with the owner's
                            decision
                          </small>
                        </div>
                      </div>
                    ...
                    <div className="col-md-6">
                      <div className="d-flex align-items-start">
                        <div className="bg-info bg-opacity-10 rounded-circle p-2 me-3 flex-shrink-0">
                          <i className="bi bi-4-circle text-info" />
                        </div>
                        <div>
                          <h6 className="mb-1">Arrange Pickup</h6>
                          <small className="text-muted">
                            If approved, coordinate pickup/delivery with the
                            owner
                          </small>
                        </div>
                      </div>
