...
function RentalHistory() {
  ...
  const renderStarRating = rating => {
    ...
    if (rating === null)
      return <span className="text-muted small">Not rated</span>;
      ...
      <div className="row mb-4">
        <div className="col">
          ...
          <p className="text-muted">
            View and manage all your past and current equipment rentals.
          </p>
        </div>
      </div>
                ...
                <div className="d-flex justify-content-between align-items-center">
                  <div>
                    <span className="text-muted small">
                      ...
                      {filteredRentals.length !== 1 ? "s" : ""} found
                    </span>
                  </div>
        ...
        <div className="col-12">
          {loading ? (
                  ...
                  <tbody>
                    {sortedRentals.map(rental => (
                      <tr key={rental.id}>
                        ...
                        <td>{renderStarRating(rental.rating)}</td>
                        <td>
            ...
            <div className="text-center py-5 bg-light rounded">
              <div className="py-4">
                <i className="bi bi-calendar-x text-muted display-1" />
                  ...
                  <div className="col-md-3">
                    <div className="d-flex align-items-center">
                      <div className="bg-info bg-opacity-10 p-3 rounded me-3">
                        <i className="bi bi-clipboard-check text-info fs-4" />
                      </div>
                      <div>
                  ...
                  <div className="col-md-3">
                    <div className="d-flex align-items-center">
                      <div className="bg-warning bg-opacity-10 p-3 rounded me-3">
                        <i className="bi bi-star-half text-warning fs-4" />
                      </div>
                      <div>
