          ...
          <div className="card h-100 border-0 shadow-sm">
            <div className="card-body text-center">
              <div className="text-warning mb-2">
                <i className="bi bi-clock-history display-6" />
              </div>
          ...
          <div className="card h-100 border-0 shadow-sm">
            <div className="card-body text-center">
              <div className="text-success mb-2">
                <i className="bi bi-check-circle display-6" />
              </div>
              <h3 className="fw-bold">
                {
                  processedRequests.filter(req => req.status === "approved")
                    .length
                }
              </h3>
          ...
          <div className="card h-100 border-0 shadow-sm">
            <div className="card-body text-center">
              <div className="text-danger mb-2">
                <i className="bi bi-x-circle display-6" />
              </div>
              <h3 className="fw-bold">
                {
                  processedRequests.filter(req => req.status === "declined")
                    .length
                }
              </h3>
          ...
          <div className="card h-100 border-0 shadow-sm">
            <div className="card-body text-center">
              <div className="text-info mb-2">
                <i className="bi bi-list-check display-6" />
              </div>
              <h3 className="fw-bold">
            ...
            <div>
              {processedRequests.length > 0 ? (
                        ...
                        {processedRequests.map(request => (
                          <tr key={request.id}>
                            ...
                            <td>
                              <div className="small">
                                {formatDateTime(
                                  request.approvedAt || request.declinedAt,
                                )}
                              </div>
                ...
                <div className="text-center py-5">
                  ...
                  <p className="text-muted">
                    You haven't processed any rental requests yet.
                  </p>
                </div>
              )}
            </div>
                ...
                <div className="mb-3">
                  ...
                  <div className="bg-light p-3 rounded">
                    ...
                    <small className="text-muted">
                      Requested by: {selectedRequest.renterName} (
