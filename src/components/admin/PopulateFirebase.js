...
const sampleEquipment = [
  ...
  
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1594736797933-d0201ba2fe65?w=400",
  },
  {
    name: "Bulldozer (D6)",
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1581094289139-bbf3c3cd1b05?w=400",
  },
  {
    name: "Bulldozer (D9)",
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1586864387789-628b9d4bbf1b?w=400",
  },
  {
    name: "Backhoe Loader",
    description:
      "Versatile machine for digging and loading in smaller construction sites.",
    category: "Construction Equipment",
    ratePerDay: 450,
    available: true,
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1581093804475-577d72e38aa0?w=400",
  },
  {
  ...
  },
  {
    ...
    description:
      "All-terrain forklift with extendable boom for varied heights.",
    category: "Material Handling",
    ratePerDay: 350,
    available: true,
  ...
  },
  {
    ...
    description:
      "Efficient for loading trucks with loose materials like gravel.",
    category: "Construction Equipment",
    ratePerDay: 650,
    available: true,
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1504148455328-d0db6de23d2d?w=400",
  },
  {
...
function PopulateFirebase() {
  ...
  const populateEquipment = async () => {
    ...
    try {
      ...
      for (let i = 0; i < sampleEquipment.length; i++) {
        ...
        setStatus(
          `Adding equipment ${i + 1}/${sampleEquipment.length}: ${equipment.name}`,
        );

        // Assign a random demo owner ID
        const randomOwnerId =
          demoOwnerIds[Math.floor(Math.random() * demoOwnerIds.length)];
        ...
        const equipmentData = {
          ...
          status: "approved",
          available:
            equipment.available !== undefined ? equipment.available : true,
      ...
      setStatus(
        `✅ Completed! Added ${successCount} equipment items successfully`,
      );
  ...
  const clearAllEquipment = async () => {
    if (
      !window.confirm(
        "⚠️ Are you sure you want to delete ALL equipment? This cannot be undone!",
      )
    ) {
      return;
    }
  ...
  const checkCurrentEquipment = async () => {
    ...
    try {
      ...
      setStatus(
        `Found ${equipment.length} equipment items in ${categories.length} categories (${availableCount} available)`,
      );
      setResults({
          ...
          <div className="card">
            ...
            <div className="card-body">
              <div className="alert alert-info">
                ...
                <ul className="mb-0">
                  <li>
                    Adds {sampleEquipment.length} sample equipment items to your
                    Firebase database
                  </li>
                  ...
                  <li>
                    Multiple categories: Construction Equipment, Power Tools,
                    Aerial Equipment, etc.
                  </li>
                </ul>
              </div>
              ...
              <div className="d-grid gap-2 mb-4">
                ...
                >
                  {loading ? (
                    ...
                    <>
                      🚀 Populate Firebase with {sampleEquipment.length}{" "}
                      Equipment Items
                    </>
                  )}
                </button>
                ...
                >
                  {loading
                    ? "Deleting..."
                    : "🗑️ Clear All Equipment (Dangerous!)"}
                </button>
              </div>
                ...
                <div className="card mt-3">
                  ...
                  <div className="card-body">
                    ...
                    {results.total !== undefined && (
                      <div>
                        <p className="mb-1">
                          <strong>📦 Total Equipment:</strong> {results.total}
                        </p>
                        <p className="mb-1">
                          <strong>✅ Available:</strong> {results.available}
                        </p>
                        <p className="mb-1">
                          <strong>🏷️ Categories:</strong> {results.categories}
                        </p>
                    ...
                    {results.deleted !== undefined && (
                      <p className="mb-1 text-danger">
                        <strong>🗑️ Deleted:</strong> {results.deleted} items
                      </p>
                    )}
                  </div>
                </div>
              ...
              <div className="card mt-3">
                ...
                <div className="card-body">
                  <ol>
                    <li>
                      Click "Check Current Equipment Count" to see what's
                      already in your database
                    </li>
                    <li>
                      Click "Populate Firebase" to add all{" "}
                      {sampleEquipment.length} sample equipment items
                    </li>
                    <li>
                      Go to your Renter Dashboard to see all the new equipment
                    </li>
                    <li>
                      Use "Clear All Equipment" only if you want to start fresh
                      (be careful!)
                    </li>
                  </ol>
                  ...
                  <div className="alert alert-warning mt-3">
                    <small>
                      <strong>⚠️ Note:</strong> This tool assigns random owner
                      IDs to equipment. In a real app, each piece of equipment
                      would belong to the user who added it.
                    </small>
                  </div>
                </div>
              </div>
