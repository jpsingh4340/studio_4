  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      await updateDoc(doc(db, "equipment", equipment.id), {
        ...
        totalBookings: equipment.totalBookings
        ...
        <div className="col-lg-8">
          ...
          <div className="mb-4">
            ...
            <p className="text-muted">
              Secure payment for your equipment rental
            </p>
          </div>
                  ...
                  <div className="card-body">
                    ...
                    {paymentMethod === "paypal" && (
                      <div className="text-center py-4">
                        <i className="bi bi-paypal display-1 text-primary mb-3" />
                        <p className="text-muted">
                    ...
                    <div className="alert alert-info">
                      ...
                      is encrypted and secure. We never store your card details.
                    </div>
              ...
              <div className="card border-0 shadow-sm">
                <div className="card-body py-5">
                  ...
                  <p className="text-muted mb-4">
                    Your payment has been processed successfully. Here are your
                    rental details:
                  </p>
                    ...
                    <div className="col-md-6">
                      <div className="border rounded p-3">
                        <div className="row g-2 text-start">
                          ...
                          <div className="col-6">{equipment.name}</div>
                          <div className="col-6">
                          ...
                          <div className="col-6">{equipment.ownerName}</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-4">
                    <small className="text-muted">
                      <i className="bi bi-info-circle me-1" />A confirmation
                      email has been sent to {currentUser.email}
                    </small>
                  </div>
                </div>
              </div>
