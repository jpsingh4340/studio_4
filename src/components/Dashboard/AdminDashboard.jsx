    ...
    >
      ...
      <Modal.Body className={isDarkMode ? "bg-dark text-light" : ""}>
        ...
        <div className="mb-4">
          ...
          <Card
            className={
              isDarkMode ? "bg-secondary border-secondary" : "bg-light"
            }
          >
            <Card.Body>
              <Row>
                <Col md={6}>
                  <p>
                    <strong>Rental ID:</strong> #{dispute.rentalId?.slice(-8)}
                  </p>
                  <p>
                    <strong>Equipment:</strong> {dispute.equipmentName}
                  </p>
                  <p>
                    <strong>Type:</strong>{" "}
                    <Badge bg="warning">{dispute.type}</Badge>
                  </p>
                </Col>
                <Col md={6}>
                  <p>
                    <strong>Filed by:</strong> {dispute.reporterName}
                  </p>
                  <p>
        ...
        <Form.Group className="mb-3">
          ...
          <Form.Select
            ...
            className={isDarkMode ? "bg-dark text-light border-secondary" : ""}
          >
            <option value="resolve_favor_renter">
              Resolve in favor of renter
            </option>
            <option value="resolve_favor_owner">
            ...
            <option value="escalate_external">
              Escalate to external mediation
            </option>
          </Form.Select>
        </Form.Group>
            ...
            <Card.Body>
              <div className="d-flex justify-content-between align-items-start mb-2">
                <div>
                  ...
                  <p className="mb-0">
                    <strong>Equipment:</strong> {review.equipmentName}
                  </p>
                  <p className="mb-0">
              ...
              <div className="mt-3">
                ...
                <p
                  className={`mt-1 border p-2 rounded ${isDarkMode ? "bg-dark text-light border-secondary" : "bg-white"}`}
                >
                  {review.comment}
                </p>
              </div>
          ...
          <div>
            ...
            <Alert variant="info">
              ...
              <ul className="mb-0 mt-2">
                <li>
                  Equipment: name, category, description, ratePerDay, location,
                  ownerId
                </li>
      ...
      <Modal.Body className={isDarkMode ? "bg-dark text-light" : ""}>
        {loading ? (
          ...
          <div>
            ...
            <Row>
              ...
              <Col md={6}>
                <div className="mb-3">
                  ...
                  <p className="mb-0 ms-4">
                    <Badge
                      bg={userDetails.emailVerified ? "success" : "warning"}
                    >
            ...
            <div
              className={`p-3 rounded ${isDarkMode ? "bg-secondary" : "bg-light"}`}
            >
...
function EquipmentApprovalModal({
  equipment,
  isOpen,
  onClose,
  onEquipmentUpdate,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      onEquipmentUpdate(equipment.id, {
        ...equipment,
      ...
      <Modal.Body className={isDarkMode ? "bg-dark text-light" : ""}>
        ...
        <Row>
          ...
          <Col md={6}>
            ...
            <p>
              <strong>Rate:</strong> ${equipment.ratePerDay}/day
            </p>
            <p>
              ...
              <Col md={6}>
                <Form.Check
                  ...
                  onChange={e =>
                    setSettings({
                      ...settings,
                      autoApproveVerifiedUsers: e.target.checked,
                    })
                  }
                  className="mb-3"
                />
              ...
              <Col md={6}>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    onChange={e =>
                      setSettings({
                        ...settings,
                        maxEquipmentPerUser: parseInt(e.target.value),
                      })
                    }
                    className={
                      isDarkMode ? "bg-dark text-light border-secondary" : ""
                ...
                <Form.Check
                  ...
                  onChange={e =>
                    setSettings({
                      ...settings,
                      equipmentApprovalRequired: e.target.checked,
                    })
                  }
                  className="mb-3"
                />
...
function AdminDashboard() {
    ...
    const fetchData = async () => {
      try {
        ...
        const availableEquipment = equipment.filter(
          item => item.available && item.approvalStatus === "approved",
        ).length;
        const rentedEquipment = equipment.filter(
          item => !item.available,
        ).length;
        const pendingApproval = equipment.filter(
        ...
        const activeRenters = users.filter(
          user => user.role === "renter" && !user.banned,
        ).length;
        const equipmentOwners = users.filter(
          user => user.role === "owner" && !user.banned,
        ).length;
        ...
        try {
          ...
          activeDisputes = disputes.filter(
            dispute =>
  ...
  const getRentalStatusBadge = status => {
    switch (status) {
      ...
      case "disputed":
        return <Badge bg="dark">Disputed</Badge>;
      default:
  ...
  const filteredReviews = allReviews.filter(
    review =>
      review.equipmentName?.toLowerCase().includes(searchQuery.toLowerCase()) ||
  ...
  return (
    <>
      ...
      <div
        className={`dashboard-container d-flex ${isDarkMode ? "dark-mode" : ""}`}
      >
        {/* Sidebar */}
        <div
          className={`sidebar ${isDarkMode ? "bg-dark" : "bg-dark"} text-white`}
        >
        ...
        <div className="main-content flex-grow-1">
          {/* Header */}
          <header
            className={`dashboard-header d-flex justify-content-between align-items-center p-3 shadow-sm ${isDarkMode ? "bg-dark text-light border-bottom border-secondary" : "bg-white"}`}
          >
            <h4>{activeTab}</h4>
            <div className="d-flex align-items-center">
              {(activeTab === "Equipment" ||
                ...
                <InputGroup className="me-3" style={{ maxWidth: 220 }}>
                  ...
                  <TooltipWrapper tooltip="Search items">
                    <Button
                      variant={
                        isDarkMode ? "outline-light" : "outline-secondary"
                      }
                    >
                      <Search />
                    </Button>
              ...
              <div className="position-relative me-3">
                ...
                {showNotifications && (
                  <div
                    className={`notifications-panel ${isDarkMode ? "bg-dark border-secondary text-light" : ""}`}
                  >
                    <div
                      className={`d-flex justify-content-between align-items-center p-3 ${isDarkMode ? "border-bottom border-secondary" : "border-bottom"}`}
                    >
                      <h5 className="m-0">
                    ...
                    <div className="notifications-body">
                      {notifications.map(notif => (
                        <div
                          key={notif.id}
                          className={`notification-item p-3 enhanced-hover ${isDarkMode ? "border-bottom border-secondary" : "border-bottom"}`}
                        >
                          <div className="d-flex align-items-center">
              ...
              <Dropdown>
                ...
                >
                  <Dropdown.Item
                    ...
                    className={
                      isDarkMode ? "text-light dropdown-item-dark" : ""
                    }
                  >
          ...
          <div
            className={`dashboard-body p-4 ${isDarkMode ? "bg-dark text-light" : ""}`}
          >
            {error && (
              <Alert
                variant="danger"
              ...
              <>
                ...
                <Row className="mb-4">
                  <Col md={6} lg={3} className="mb-3">
                    <Card
                      className={`stats-card h-100 enhanced-hover ${isDarkMode ? "bg-dark border-secondary text-light" : ""}`}
                    >
                      <Card.Body>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <h2 className="mb-1">
                              {metrics.loading ? "..." : metrics.totalEquipment}
                            </h2>
                            ...
                            {metrics.pendingApproval > 0 && (
                              <Badge bg="warning" className="mt-1">
                                {metrics.pendingApproval} Pending
                              </Badge>
                            )}
                          </div>
                        </div>
                    ...
                    >
                      <Card.Body>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <h2 className="mb-1">
                              {metrics.loading ? "..." : metrics.totalRentals}
                            </h2>
                            <p className="text-muted mb-0 small">
                              Total Rentals
                            </p>
                            <Badge bg="success" className="mt-1 me-1">
                              {metrics.activeRentals} Active
                            </Badge>
                          </div>
                        </div>
                      </Card.Body>
                    ...
                    >
                      <Card.Body>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <h2 className="mb-1">
                              {metrics.loading ? "..." : metrics.totalDisputes}
                            </h2>
                            <p className="text-muted mb-0 small">
                              Total Disputes
                            </p>
                    ...
                    >
                      <Card.Body>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <h2 className="mb-1">
                              {metrics.loading ? "..." : metrics.flaggedReviews}
                            </h2>
                            <p className="text-muted mb-0 small">
                              Flagged Reviews
                            </p>
                ...
                <Row className="mb-4">
                      ...
                      <Card.Body>
                        <ResponsiveContainer width="100%" height={300}>
                          <LineChart data={chartData}>
                            <CartesianGrid
                              stroke={isDarkMode ? "#4a5568" : "#eee"}
                              strokeDasharray="5 5"
                            />
                            <XAxis
                              dataKey="month"
                              stroke={isDarkMode ? "#e2e8f0" : "#333"}
                            />
                  ...
                  <Col md={4}>
                    <Card
                      className={`h-100 ${isDarkMode ? "bg-dark border-secondary text-light" : ""}`}
                    >
                      <Card.Header
                        className={
                          isDarkMode ? "bg-dark border-secondary" : "bg-white"
                        ...
                        {recentActivity.length > 0 ? (
                          <ul className="activity-list list-unstyled">
                            {recentActivity.map(activity => (
                              <li
                                key={activity.id}
                                className="d-flex align-items-center mb-3 enhanced-hover"
                              >
              ...
              <>
                <div className="d-flex justify-content-between align-items-center mb-4">
                  ...
                  <div className="d-flex gap-2">
                    <Badge bg="success">
                      {metrics.availableEquipment} Available
                    </Badge>
                    <Badge bg="danger">{metrics.rentedEquipment} Rented</Badge>
                    <Badge bg="warning">
                      {metrics.pendingApproval} Pending Approval
                    </Badge>
                  </div>
                </div>
                    ...
                    {filteredEquipment.length > 0 ? (
                      filteredEquipment.map(equipment => (
                        <Col key={equipment.id} md={6} lg={4} className="mb-4">
                          <Card
                            className={`h-100 enhanced-hover ${isDarkMode ? "bg-dark border-secondary text-light" : ""}`}
                          >
                            <div
                            ...
                            <Card.Body className="d-flex flex-column">
                              <div className="flex-grow-1">
                                ...
                                <div className="mb-2">
                                  ...
                                  <Badge
                                    bg={
                                      equipment.available ? "success" : "danger"
                                    }
                                    className="me-2"
                                  >
                                    {equipment.available
                                  ...
                                  {equipment.approvalStatus === "pending" && (
                                    <TooltipWrapper tooltip="Review equipment">
                                      <Button
                                        ...
                                        className="enhanced-hover"
                                        onClick={() =>
                                          handleApproveEquipment(equipment)
                                        }
                                      >
                        ...
                        <div className="text-center py-5">
                          ...
                          <p className="text-muted">
                            {searchQuery
                              ...
                              : "No equipment has been added to the platform yet."}
                          </p>
                        </div>
                      </Col>
                    )}
            ...
            {activeTab === "Rentals" && (
              <>
                <div className="d-flex justify-content-between align-items-center mb-4">
                  ...
                  <div className="d-flex gap-2">
                    <Badge bg="warning">
                      {allRentals.filter(r => r.status === "pending").length}{" "}
                      Pending
                    </Badge>
                    <Badge bg="success">{metrics.activeRentals} Active</Badge>
                    <Badge bg="primary">
                      {metrics.completedRentals} Completed
                    </Badge>
                    <Badge bg="danger">
                      {allRentals.filter(r => r.status === "cancelled").length}{" "}
                      Cancelled
                    </Badge>
                  </div>
                </div>
            ...
            {activeTab === "Dispute Center" && (
              <>
                <div className="d-flex justify-content-between align-items-center mb-4">
                  ...
                  <div className="d-flex gap-2">
                    <Badge bg="danger">
                      {allDisputes.filter(d => d.status === "open").length} Open
                    </Badge>
                    <Badge bg="warning">
                      {
                        allDisputes.filter(d => d.status === "investigating")
                          .length
                      }{" "}
                      Investigating
                    </Badge>
                    ...
                    <Badge bg="secondary">
                      {allDisputes.filter(d => d.status === "closed").length}{" "}
                      Closed
                    </Badge>
                  </div>
                </div>
                                ...
                                <td>
                                  <div className="d-flex align-items-center">
                                    ...
                                    <div>
                                      ...
                                      <small className="text-muted">
                                        Rental #{dispute.rentalId?.slice(-8)}
                                      </small>
                                    </div>
                                  </div>
                                </td>
                            ...
                            <tr>
                              <td colSpan="8" className="text-center py-4">
                                ...
                                {searchQuery ? (
                                  ...
                                  <p className="text-muted">
                                    Great! No active disputes on the platform.
                                  </p>
                                )}
                              </td>
                            </tr>
                ...
                <div className="d-flex justify-content-between align-items-center mb-4">
                  ...
                  <div className="d-flex gap-2">
                    <Badge bg="warning">
                      {
                        allReviews.filter(
                          r => r.moderationStatus === "pending" || r.flagged,
                        ).length
                      }{" "}
                      Flagged
                    </Badge>
                            ...
                            <tr>
                              <td colSpan="8" className="text-center py-4">
                                ...
                                {searchQuery ? (
                                  ...
                                  <p className="text-muted">
                                    No reviews need moderation at this time.
                                  </p>
                                )}
                              </td>
                            </tr>
                ...
                <Row>
                  <Col md={6}>
                    ...
                    >
                      ...
                      <Card.Body>
                        <p className="text-muted">
                          Equipment distribution by category analysis coming
                          soon.
                        </p>
                      </Card.Body>
                    </Card>
                  ...
                  <Col md={6}>
                    ...
                    >
                      ...
                      <Card.Body>
                        <p className="text-muted">
                          Revenue tracking and projections coming soon.
                        </p>
                      </Card.Body>
                    </Card>
                  </Col>
                    ...
                    >
                      ...
                      <Card.Body>
                        ...
                        <div className="d-flex justify-content-between align-items-center mb-2">
                          ...
                          <Badge
                            bg={
                              metrics.activeDisputes > 0 ? "danger" : "success"
                            }
                          >
                            {metrics.activeDisputes}
                          </Badge>
                        ...
                        <div className="d-flex justify-content-between align-items-center mb-3">
                          ...
                          <Badge
                            bg={
                              metrics.flaggedReviews > 0 ? "warning" : "success"
                            }
                          >
                            {metrics.flaggedReviews}
                          </Badge>
