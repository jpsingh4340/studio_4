  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      const equipmentData = {
        ...
        // Equipment status
        available: true,
        approvalStatus: "approved", // Setting to 'approved' to enable immediate rental
        isApproved: true, // Additional flag to ensure it's recognized as approved
        status: "approved", // Explicitly set status field for direct database queries
  ...
  return (
    <div className="container py-4">
            ...
            <div className="card-body p-4">
              ...
              {process.env.NODE_ENV === "development" && (
                <div className="alert alert-info small mb-4">
                  ...
                  <br />
                  User ID: <code>{currentUser.uid}</code>
                  <br />
                ...
                <div className="row g-3">
                  ...
                  <div className="col-12">
                    ...
                    <div className="form-text">
                      Detailed descriptions help renters understand what they're
                      getting
                    </div>
                  </div>
                  ...
                  <div className="col-12">
                    ...
                    />
                    <div className="form-text">
                      Separate features with commas. These help your equipment
                      stand out.
                    </div>
                  </div>
      ...
      <FeedbackModal
        ...
        message={`Your equipment "${formData.name || "equipment"}" has been added to the marketplace and is immediately available for rent. No approval waiting period!`}
